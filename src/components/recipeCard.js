...
function Recipe({ recipe: propRecipe }) {
  ...
  const recipes = {
    1: {
      ...
      tags: ['Dinner', 'Beef'],
      intro: `Jamaican Pepper Steak is a vibrant and hearty dish that combines tender strips of beef with a medley of colorful bell peppers, all coated in a rich, savory sauce infused with bold Caribbean flavors. This dish captures the essence of Jamaican cuisine with its perfectly balanced blend of sweet, smoky, and spicy notes, making it a comforting yet exciting meal. Perfect for weeknight dinners or special occasions, Jamaican Pepper Steak pairs beautifully with steamed rice or traditional rice and peas, ensuring every bite is a burst of flavor and texture.`,
      ingredients: [
  ...
  7. Whisk beef broth mixture to recombine. Add mixture to skillet; reduce heat to medium; and cook, stirring occasionally, until thickened (spatula will start to leave trail that quickly fills in), 4 to 6 minutes. Stir in beef and vegetables and cook until heated through, about 1 minute. Season with salt and pepper to taste. Serve.
    ...
    2: {
      ...
      intro: `Jamaican Stuffed Red Snapper is a show-stopping dish that marries bold Caribbean spices with the delicate, flaky texture of fresh snapper. Whole fish is generously stuffed with a vibrant mix of seasoned greens, aromatic herbs, and spices, then wrapped in foil to lock in its incredible flavors and moisture. Cooked over an open flame, this dish delivers a tantalizing smoky aroma and a perfectly charred exterior. Ideal for summertime gatherings or any festive occasion, this flavorful and practical recipe is sure to impress guests and transport taste buds straight to the islands.`,
      ingredients: [
...
`,
    ...
    3: {
      ...
      tags: ['Pork', 'Stews'],
      intro: `Jamaican Stew Peas with Spinners is a comforting and hearty dish that embodies the soul of Jamaican home cooking. This rich stew features tender red beans, smoky meats, and creamy coconut milk, simmered together with fragrant herbs and spices to create a symphony of flavors. The addition of spinners—soft, hand-rolled dumplings—adds a delightful texture and makes this dish even more satisfying. Often served over steamed rice, Jamaican Stew Peas is a beloved staple that showcases the warmth and depth of Caribbean cuisine, making it perfect for sharing with family and friends.`,
  ...
  return (
    <div className="recipe-container">
      ...
      <div className="recipe-directions">
        <h2>Directions</h2>
        <ReactMarkdown className="formatted-directions">{recipe.steps}</ReactMarkdown>
